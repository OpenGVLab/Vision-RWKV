...
_C.DATA.DATA_PATH = ''
_C.DATA.DATA_PATH_VAL = ''  # for imagenet22k val
# Dataset name
...
# VRWKV parameters
_C.MODEL.VRWKV = CN()
_C.MODEL.VRWKV.IMG_SIZE = 224
_C.MODEL.VRWKV.PATCH_SIZE = 16
_C.MODEL.VRWKV.IN_CHANNELS = 3
_C.MODEL.VRWKV.OUT_INDICES = -1
_C.MODEL.VRWKV.DROP_RATE = 0.
...
_C.MODEL.VRWKV.POST_NORM = False
_C.MODEL.VRWKV.K_NORM = True
_C.MODEL.VRWKV.INIT_VALUES = None
_C.MODEL.VRWKV.HIDDEN_RATE = 4  # in channel mix and spatial mix
...
# could be overwritten by command line argument
_C.TRAIN.USE_CHECKPOINT = False  # with_cp
